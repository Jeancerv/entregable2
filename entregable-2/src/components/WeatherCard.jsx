  ...
  return (
    <article className='card'>
        ...
        <div className='card__body'>
            ...
            <img className='card__img' src={`http://openweathermap.org/img/wn/10d@4x.png`} alt="" />
        </div>
        <section className='card__info'>
            ...
            <ul className='card__info-body'>
                ...
                <li className='card__info-item' ><span className='card__info-label'>Cloud</span>(weather?.clouds.all)%</li>
